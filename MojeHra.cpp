...
void TwoMonstrs(){
    ...
    case 0:
        PlayerAttack1();
        while (end == 0 && (Enemy.HP + Enemy1.HP)> 0)
        {
            cout << "Monstrum ještě žije. Útočí na tebe. ";
            EnemyAttack1();
            cin >> Choice1;
